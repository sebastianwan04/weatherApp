...
class weatherApp {
    ...
    displayWeatherData = (data) => {
        ...
        this.viewElems.weatherCurrentTemp.innerText =
            "Current temperature: " + weather.the_temp.toFixed(2) + " °C";
        this.viewElems.weatherMaxTemp.innerText =
            "Max temperature: " + weather.max_temp.toFixed(2) + " °C";
        this.viewElems.weatherMinTemp.innerText =
            "Min temperature: " + weather.min_temp.toFixed(2) + " °C";
    };
}
